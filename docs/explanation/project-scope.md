...
`ci/agnosticism_check.sh` greps `forge/core`, `forge/contracts`,
`forge/generation`, `forge/hls`, `forge/verification`, `forge/analysis`,
and `forge/integration` for a blocklist of
