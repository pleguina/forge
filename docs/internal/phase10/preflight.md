...
- Mailbox-transfer pipelining (more than one outstanding transaction,
  ...
  implementation.
- 10.7C (provenance/plan-hash CLI-workflow tests and visual explorer
  application for this plugin) and 10.7D (documentation/README/CI wiring
  beyond 10.1 scope) — still open, deferred from the 10.7 sub-slice split
  (§11) to later sessions. (10.7B — generic platform wrapper — is DONE.)
