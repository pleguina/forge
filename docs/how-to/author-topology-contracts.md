# How to Author Topology Contracts
...
|----------|----------|---------|
| Contracts and Protocols | [concepts/contracts-and-protocols.md](../concepts/contracts-and-protocols.md) | Contract rules |
...
See [How to Analyze Performance](analyze-performance.md) for the full command
reference and probe CSV format.

---

## Validating your contract

`verify-contract` answers three questions about an interface contract, and
nothing about raw naming conventions or internal HLS coding style:
...
forge core verify-contract \
    ...
    --contract plugins/<plugin>/forge/interfaces/my_ip.interface.yaml

# Verify all known contracts in the workspace:
forge core verify-contract \
    --ip-info ip_info.yaml \
    --all-contracts plugins/<plugin>/forge/interfaces/
```
