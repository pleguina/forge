...
protocol from layer A's format loaders (:mod:`forge.verification.dataset_format`),
...
from forge.verification.dataset_format import DatasetMetadata, SerializedDataset
...
class DatasetSource:
    ...
    :class:`~forge.verification.dataset_format.SerializedDataset` (the common
...
def register_dataset_adapter(adapter_id: str, adapter: ProjectDatasetAdapter) -> None:
    ...
    Mirrors :func:`forge.verification.dataset_format.register_format_loader`'s
