...
This module does NOT own:
  ...
  * Artifact existence checks                                   → forge.verification.preflight
  * Backend discovery or dispatch                               → forge.verification.backend_registry
...
from forge.verification.exceptions import (
    FlowConfigError,
...
def parse_generic_flow_fields(
    ...
    if _plugin_id is not None:
        import forge.verification.plugin_registry as _pr  # local import: avoids circular dep
        try:
    ...
    import forge.verification.backend_registry as _br  # local import: populated by plugin shim
