"""forge.analysis.throughput_runtime.probe — build
:class:`~forge.verification.throughput_result.RuntimeThroughputResult` from a
real simulation's Tier 2 probe CSV.

Reuses :func:`forge.analysis.latency_runtime.probe.load_wide_probe_csv`
...
from forge.analysis.latency_runtime.probe import ProbeEvent, load_wide_probe_csv
