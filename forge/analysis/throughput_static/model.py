"""forge.analysis.throughput_static.model — build
...
module's already-parsed :class:`~forge.analysis.hls_reports.extractor.HLSModuleReport`
...
``forge.analysis.latency_static`` already uses for latency — nominal
...
from forge.analysis.hls_reports.extractor import HLSModuleReport
