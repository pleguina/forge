...
Python API
----------
    from forge.verify.preflight import run_preflight, PreflightResult
...
if TYPE_CHECKING:
    from forge.verify.flow_loader import FlowConfig
...
def run_preflight(cfg: "Any", xml_input: "Path | None" = None) -> PreflightResult:
    ...
    if _flow_file is not None:
        from forge.verify.layout import validate_layout as _vl  # noqa: PLC0415
