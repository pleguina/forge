"""
FORGE External Framework Integration
...
The provider model is intentionally open: `forge.integration.importer.load()`
...
hardcoded: `forge.integration.io_resolver.resolve()` derives detector input
