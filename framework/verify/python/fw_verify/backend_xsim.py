...
from fw_verify.backend_base import (
    ArtifactRequirement,
    BackendAdapter,
    BackendCapabilities,
    ExecutionResult,
...
class XsimBackend(BackendAdapter):
    ...
    def validate_backend_requirements(self, cfg: Any) -> list[str]:
        ...
        from fw_verify.layout import validate_layout  # noqa: PLC0415
        ...
        from fw_verify.stimulus_contract import STIMULUS_FILE  # noqa: PLC0415
    ...
    def prepare_backend_inputs(self, cfg: Any, ctx: Any) -> None:
        ...
        if manifest is not None:
            from fw_verify.manifest_compile import prepare_from_manifest  # noqa: PLC0415
...
def _run_logged(cmd: list[str], log_file: Path, cwd: Path | None = None) -> int:
    ...
    """
    try:
        from fw_verify.subprocess_wrapper import run_subprocess  # noqa: PLC0415
