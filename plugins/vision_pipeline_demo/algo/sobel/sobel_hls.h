...
// plus gradient_magnitude's own frozen width (preflight.md §9).
...
// sobel_hls — slice 10.2 (release-plan Phase 10, preflight.md §6.3): a
...
// window taps it's handed (preflight.md §9.1, frozen), using the
