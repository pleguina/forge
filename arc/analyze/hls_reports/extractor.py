"""arc.analyze.hls_reports.extractor
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Walk a build_hls/ tree and collect per-module synthesis reports.

Re-uses ``HLSMetricsExtractor`` from ``arc.hls.extract_hls_metrics`` so the
...
def _parse_xml(xml_path: Path, module_name: str, solution: str) -> HLSModuleReport:
    from arc.hls.extract_hls_metrics import HLSMetricsExtractor
