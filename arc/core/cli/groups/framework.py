"""arc framework — external framework import and detector I/O resolution."""
...
def cmd_import(args):
    ...
    from arc.framework.importer import load, FrameworkImportError
...
def cmd_io_resolve(args):
    ...
    from arc.framework.importer import load, FrameworkImportError
    from arc.framework.io_resolver import resolve, write_resolved, DetectorIOError
...
def cmd_emit_payload(args):
    ...
    from arc.framework.importer import load, FrameworkImportError
    from arc.framework.io_resolver import DetectorIOResolved, ResolvedInput, ResolvedOutput
    ...
    if args.detector_io:
        ...
        from arc.framework.io_resolver import (
        ...
        def _ep_from_dict(d):
            from arc.framework.importer import Endpoint
            return Endpoint(
