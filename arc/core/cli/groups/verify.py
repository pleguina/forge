"""arc verify — simulation and verification orchestration.

Delegates all sub-commands transparently to :mod:`arc.verify.__main__`.
"""
...
def register(sub) -> None:
    """Register the ``arc verify`` subparser."""
    p_verify = sub.add_parser(
        ...
        epilog=(
            ...
            "  arc verify run plugins/my_plugin/verify/hit_decoder_xsim/verify.flow.yml"
            " --plugin my_plugin\n"
