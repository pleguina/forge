...
Validation rules (all must pass before writing output):
  ...
  6.  Every frontend module must exist in the ARC module registry.
"""
...
from arc.framework.importer import Endpoint, FrameworkImport
...
def resolve(
    ...
    framework:
        Loaded FrameworkImport (from arc.framework.importer.load).
    registry_modules:
